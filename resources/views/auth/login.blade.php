    ...
    <div class="flex">
        <div class="w-full">
            <section class="flex flex-col break-words bg-white sm:border-1 sm:rounded-md sm:shadow-sm sm:shadow-lg">
                ...
                <header class="font-semibold bg-green-100 text-gray-700 py-3 text-center sm:py-3 sm:rounded-t-md text-2xl text-first">
                ...
                <form class="w-full px-6 space-y-6 sm:px-10 sm:space-y-8" method="POST" action="{{ route('login') }}">
                    ...
                    <div class="flex flex-wrap">
                        ...
                        <p class="w-full text-xs text-center text-gray-700 my-6 sm:text-sm sm:my-8">
                            ...
                            <a class="text-first hover:text-blue-700 no-underline hover:underline text-xl" href="{{ route('register') }}">
                                {{ __('Register') }}
                            </a>
                        </p>
                        @endif
